...
// export async function getServerSideProps({ params }) {
//   const results = await fetch(
//     "https://www.postman.com/collections/a7ade4014d7d410ce982"
//   ).then((r) => r.json());
//   var res;
//   const clearResults = results.item[1].item[1].item[0].item[2].response[0].body;

//   const clearResult = JSON.parse(clearResults);

//   clearResult.response.data.map((result) => {
//     if (result.slug === params.slug) {
//       res = result;
//     } else {
...
//   // item[8].item[0].item[0].request.body.raw
...
// export async function getServerSidePaths() {
//   const res = await fetch(
//     `https://www.postman.com/collections/a7ade4014d7d410ce982/api/challenge?type=EVENT`
//   ).then((r) => r.json());
//   // console.log("tyer", res.response.data.length);
//   return {
//     paths: res.response.data.map((data) => {
...
// async function getBrowserLocationByIp() {
//   const url = "https://api.ipstack.com/check";
//   return get(url, {access_key: 'ada325085f484785cbc7c17fb889e918'}, {}).catch(() => false);
// }
...
//       )
//       .filter((schedule) => new Date(schedule.startDate) > new Date());
//   const nextSchedule = upcomingSchedules && upcomingSchedules.length > 0 && upcomingSchedules[0]
//   const sd = new Date((nextSchedule && nextSchedule.startDate) || event.start_date);
//   const ed = new Date((nextSchedule && nextSchedule.endDate) || event.end_date);
//   const week = weeks[sd.getDay()];
//   const month = months[sd.getMonth()];
//   const date = sd.getDate();
...
//                 📍20 Baker Street, London, 20012, England
//                 </p>
//               </div>
//             </div>
//              <div className={styles.share}>
...
//                   <b>Topics include </b>
//                   <ol className={styles.list}>
//                     <li> Initiating breastfeeding in Golden Hour</li>
//                     <li> Newborn stomach sizes</li>
//                     <li> Stages of breastmilk</li>
//                     <li> Different BF positions</li>
//                     <li> How to get a good latch</li>
//                     <li> Tips for successful BF</li>
//                     <li> How to know if baby is getting enough milk</li>
//                     <li> How to burp the baby</li>
//                     <li> Mother’s diet during BF</li>
//                     <li> Going back to work - expressing & storing breastmilk</li>
...
//         </div>
//         <div className={styles.whatsIncluded}>
//           <p className={styles.header}><img src="/images/Vector.svg"/>What&apos;s Included</p>
//           <div className={styles.teaks}>
//           {/* {whatsIncluded.map((wi) => (
//               <HighlightTeak
//                 key={wi.id}
